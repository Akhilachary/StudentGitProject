	...
	public static void main(String[] args) {
		...
		while (true) {
			...
			case 1: {
				...
				Student student = implementation.getStudentById(sid);
				if (student == null) {
					System.err.println("Student with ID " + sid + " is not found");
				} else {
			...
			case 3: {
				...
				System.out.println("Enter Student ID");
				int id = sc.nextInt();
				if (implementation.updateStudent(id)) {
					System.err.println("Student with ID " + id + " is Updated Successfully");
				} else {
					System.err.println("Student with ID " + id + " is not found");
				}
			}
				break;
